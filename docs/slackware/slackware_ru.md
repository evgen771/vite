### В KDE5 Plasma (Slackware 15) средствами системы
...
В Plasme будет русский язык и форматы,если все правильно сделано.

### В остальных рабочих столах (DE),оконных менеджерах (WM)

Если вы установили дистрибутив полностью, то вам необходимо поменять всего лишь пару строк, в двух файлах, чтобы русифицировать **Slackware**. 
 
А именно, файлы в директории `/etc/rc.d/`
